...
function handleFormSubmit(e) {
    ...
    // Simulate API call with demo prediction
    setTimeout(() => {
        hideLoading();
...
function generateMockPrediction() {
    ...
    // Advanced scoring algorithm for realistic predictions
    let score = 0;
    
    // Sleep duration scoring (most important)
    if (formData.sleep_duration >= 7 && formData.sleep_duration <= 9) {
        score += 3;
    } else if (formData.sleep_duration >= 6 && formData.sleep_duration <= 10) {
        score += 1.5;
    } else {
        score -= 1;
    }
    ...
    // Exercise scoring
    if (formData.exercise_duration >= 45) {
        score += 2;
    } else if (formData.exercise_duration >= 30) {
        score += 1;
    } else if (formData.exercise_duration < 15) {
        score -= 0.5;
    }
    
    // Screen time scoring
    if (formData.screen_time <= 30) {
        score += 1.5;
    } else if (formData.screen_time <= 60) {
        score += 0.5;
    } else if (formData.screen_time > 180) {
        score -= 1;
    }
    ...
    if (formData.stress_level <= 3) {
        ...
        score += 0.5;
    } else if (formData.stress_level > 8) {
        score -= 1;
    }
    
    // Caffeine scoring
    if (formData.caffeine_intake === 'None') {
        score += 1;
    } else if (formData.caffeine_intake === 'Low') {
        score += 0.5;
    } else if (formData.caffeine_intake === 'High') {
        score -= 0.5;
    }
    ...
    if (formData.sleep_interruptions === '0') {
        score += 1.5;
    } else {
        score -= 0.5;
    }
